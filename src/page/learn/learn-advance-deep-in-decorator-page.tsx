    ...
    render() {
        return (
            <ContentLayout sideMenu={<SideMenu />}>
                ...
                <Card>
                    <ul>
                        <li>只会使用装饰器表达式的第一个参数</li>
                        <li>如果希望接受多个装饰器参数，只能为元数据类定义多个field，同时装饰器参数只能使用纯对象</li>
                        <li>如果元数据类只有一个field，且不是赋值给默认值，那么需要给key添加默认值，哪怕是undefined</li>
                    </ul>
                </Card>
            </ContentLayout>
        );
